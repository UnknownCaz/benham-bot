...
def main():
    ...
    try:
        ...
        # The spawn_in_room section (pointer not content, resume split,
        # auto-post) stood here; the spawn half of rooms left with the PC lane
        # in Phase B (INTENT 39). rooms.json's worker record is inert data now.
    finally:
