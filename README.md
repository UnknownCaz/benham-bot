...
<!-- GENERATED:count -->
`do` covers all 53 registered capabilities and replaces the need for a script per action. The older single-purpose CLIs below still work and route through their original code paths.
<!-- /GENERATED:count -->
